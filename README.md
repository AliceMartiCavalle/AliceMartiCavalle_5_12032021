...
Est-ce que je peux forcer le select de couleur à se remettre sur la 1ère option quand on change de nounours dans la page produit ? J'ai mis en 'selected' mais l'affichage suit pas.
...
- Harmoniser convention de nommage : maj en début de toutes les fonctions
